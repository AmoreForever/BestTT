...
START_BUTTONS=[
    [
        InlineKeyboardButton('Source', url='https://github.com/AmoreForever/BestTT'),
        InlineKeyboardButton('Project Channel', url='https://t.me/the_farkhodov'),
    ],
    [InlineKeyboardButton('Author', url='https://t.me/sngscamer')],
]
